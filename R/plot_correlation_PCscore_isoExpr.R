plot_correlation_PCscore_isoExpr <- function(res_isomas,nfeat.pos = NULL, nfeat.neg = NULL,
  ...
  data.heat = plot_isomas_heatmap(res_isomas,dims = PCs, nfeat.pos = nfeat.pos, nfeat.neg = nfeat.neg,
